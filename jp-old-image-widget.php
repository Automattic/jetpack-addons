<?php
/*
 * Plugin Name: Jetpack - Old Image Widget
 * Plugin URI: http://wordpress.org/plugins/jetpack/
 * Description: Restores older Jetpack image widget
...
register_widget( 'Old_Jetpack_Image_Widget' );
}

class Old_Jetpack_Image_Widget extends WP_Widget {
	/**
